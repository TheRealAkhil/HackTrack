...
login = function(email, password) {
	...
	var headers = { "Content-Type": "application/json" , "auth": "Telerik169" };

	http.request({
		url: "http://sandboxdb-42183.onmodulus.net/login",
		method: "POST",
		headers: headers,
...
store = function(email, password) {
	...
	http.request({
		url: "http://sandboxdb-42183.onmodulus.net/resetpassword",
		method: "POST",
		headers: headers,
		content: JSON.stringify(content)
	}).then(function(response) {
